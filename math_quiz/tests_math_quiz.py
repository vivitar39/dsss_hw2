...
class TestMathGame(unittest.TestCase):
    ...
    def test_random_arithmetic_operation(self):
        """Tests if the function returns a valid operator."""
        valid_operators = ['+', '-', '*']
    ...
    def test_arithmetic_operation(self):
        ...
        for number1, number2, operation, expected_problem, expected_answer in test_cases:
            problem, answer = create_math_problem(number1, number2, operation)
